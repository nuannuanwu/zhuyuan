    ...
    try:
        ...
        if match:
            for i in range(len(match)):
                ...
                html = '<video class="html5video" controls="controls" width="550" height="380" poster="http://99.pyflask.sinaapp.com/_static/memory/img/logo.png"><source src="' + match[i] + '" type="video/mp4" /></video>'
