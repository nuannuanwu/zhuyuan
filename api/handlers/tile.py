...
from memory.models import Tile, TileTag, TileType, Group, TileCategory, Activity,TileToActivity
...
class TileHandler(BaseHandler):
    model = Tile
    fields = ('id', 'title', 'image','category', 'image_large','image_middle', 'user', 'description', 'content', 'url', 'n_likers', 'n_comments', 'ctime', 'liked','comments',
        ('type', ()), ('tags', ()))
    allowed_methods = ("GET")
